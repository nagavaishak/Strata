  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
        <div>
          <p className="text-sm font-medium text-muted-foreground">{presentation.homeTeam} vs {presentation.awayTeam}</p>
        ...
        <div className="inline-flex w-fit flex-col rounded-[28px] border border-border/70 bg-background/40 px-5 py-4 text-right">
          ...
          <span className="mt-2 text-2xl font-semibold text-foreground">{presentation.homeTeam}</span>
          <span className="text-sm text-muted-foreground">vs</span>
          <span className="text-2xl font-semibold text-foreground">{presentation.awayTeam}</span>
        </div>
      </div>
    </div>
  );
